        ...
        <div className="shadow-md bg-primary text-white duration-200">
            <div className="container py-3 sm:py-5">
                <div className="flex justify-between items-center">
                    ...
                    <Link to={Menu[0].link} className="text-base justify-center items-center sm:text-xl flex gap-2"> 
                     <img src={Logo} alt="Logo" className="w-11" />
                     MFU<br/> Sports Complex
                     </Link>
                    </div>
                    <div className="flex justify-between items-center gap-4">
                        ...
                        {Menu.map((menu) => (
                            ...
                            className={`inline-block py-4 px-4 ${
                              navmenu === menu.name ? "text-yellow-500" : "hover:text-yellow-500"
                            }`}
                            >
                            {menu.name}
                            </Link>
                            {navmenu === menu.name ? <hr className='border-none w-full h-[3px] rounded-lg bg-yellow-500' /> : <></>}
                            </li>
                             ))}
                            <li>
                            <button
